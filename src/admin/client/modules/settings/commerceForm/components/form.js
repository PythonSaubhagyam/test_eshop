			...
			<form
				...
				<Paper className="paper-box" zDepth={1}>
					<div className={style.innerBox}>
						...
						<div>
							<Field name="status" component={RadioButtonGroup} onChange={(event) => this.setSelectField(event)}>
								<RadioButton
						...
						<div>
							{this.state.isTextField && (this.state.isSelectField || this.state.isServiceOptions) && (
								<Field
									component={TextField}
									fullWidth={true}
									name="deliveryRadius"
